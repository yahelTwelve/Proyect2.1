...
const WeatherData = ({ data }) => {
    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center flex-col bg-cover max-w-screen max-h-screen" style={{ backgroundImage: fond }}>
            <article className="w-[280px] flex items-center justify-center flex-col gap-8 font-sans md:w-[450px] lg:w-[750px] lg:gap-[70px]">
                <h2 className="text-[18px] font-bold title text-gray-700 md:text-[25px]">{data.name}, {data.sys.country}</h2>
                <div className="flex flex-col w-[95%] gap-7 lg:flex-row lg:justify-center md:gap-14" >
                    <div className="flex flex-col gap-4 items-center h-[200px] justify-center bg-[#ebebebc8]  p-1 rounded-2xl shadow-lg shadow-gray-400  md:h-[260px] md:justify-evenly lg:w-[700px] lg:h-[300px]">
                        ...
                        <div className="flex justify-between items-center w-[83%] ">
                            ...
                            <img src={`https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`} alt="" className="w-14 md:w-[250px] m-4" />
                        </div>
                    </div>
